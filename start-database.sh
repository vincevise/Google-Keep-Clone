...
DB_CONTAINER_NAME="t3-demo-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=t3-demo -d -p 5432:5432 docker.io/postgres
